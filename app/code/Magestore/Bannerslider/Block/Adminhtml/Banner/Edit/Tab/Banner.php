    ...
    protected function _prepareForm()
    {
        ...
        $elements['image'] = $fieldset->addField(
            ...
            [
                ...
                'name' => 'image',
                'note' => 'Allow image type: jpg, jpeg, gif, png.<br>If image is null, it will get image from Youtube URL.',
            ]
        );
...
//        );
    ...
    public function getPageTitle()
    {
        return $this->getBanner()->getId()
            ? __("Edit Video '%1'", $this->escapeHtml($this->getBanner()->getName())) : __('New Video');
    }
